...
const metricHeadingAliases: Partial<Record<keyof TrendlyneRecord, string[]>> = {
  revenue: ["revenue annual", "total revenue annual", "revenue qtr", "net sales annual", "total income annual", "revenue"],
  profit: ["net profit annual", "net profit qtr", "profit after tax annual", "pat annual", "net profit"],
  eps: ["eps ttm", "basic eps annual", "eps annual", "earnings per share", "eps"],
  currentPrice: ["current price", "last traded price", "ltp", "close price", "day close price"],
  marketCap: ["market capitalisation", "market capitalization", "market cap"],
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const record: TrendlyneRecord = {
      ...
      reportDate: "",
      marketCap: metricValue(metrics, "marketCap") || fieldValue(sources, allText, "marketCap"),
      revenue: metricValue(metrics, "revenue") || fieldValue(sources, allText, "revenue"),
      profit: metricValue(metrics, "profit") || fieldValue(sources, allText, "profit"),
      eps: metricValue(metrics, "eps") || fieldValue(sources, allText, "eps"),
      ...
      currentPrice: metricValue(metrics, "currentPrice") || fieldValue(sources, allText, "currentPrice"),
      fiiHolding,
      diiHolding,
